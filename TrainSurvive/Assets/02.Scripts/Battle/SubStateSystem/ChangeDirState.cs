...
namespace WorldBattle {
    public class ChangeDirState : AISubState {
        ...
        //设置转身所需的时间（将会受到移速改变比率的影响）
        private const float changeDirAnimationTime = 0.2f;
        //当前等待的时间
        ...
        public override void executeState() {
            float rotateT = 180 / (changeDirAnimationTime / battleActor.moveSpeedChangeRate)
                / Quaternion.Angle(myTransform.rotation, endRotation) * Time.deltaTime;

...
namespace WorldMap.UI
{
    ...
    public abstract class BaseDialog : MonoBehaviour
    {
        ...
        protected Vector2 dialogSize = new Vector2(840F, 720F);
        ...
        private void CreateBG()
        {
            ...
            Utility.CenterAt(this, new Vector2(0.5F, 0.5F), dialogSize);
            //标题
            ...
            btns[0].onClick.AddListener(delegate () { OK(); });
            btns[0].onClick.AddListener(delegate () { Cancel(); CloseDialog(); });
        }

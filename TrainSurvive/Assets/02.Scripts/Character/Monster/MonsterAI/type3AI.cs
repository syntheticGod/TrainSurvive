...
{//【嗜血型】：始终攻击（最大生命值）最高目标  //用于削弱自身过强怪物

   public class type3AI : BattleActor
   {
       ...
       protected override void AIStrategy()
       {
           ...
           foreach (BattleActor enemyActor in enemyActors)
           {
               ...
               {
                   if (targetId == -1 || enemyActor.maxHealthPoint > enemyActors[targetId].maxHealthPoint)
                   {
...
type3有bug 先替换成type1的代码*/
/*
 * 描述：
 * 作者：NONE
 * 创建时间：2019/1/26 14:41:21
 * 版本：v0.7
 */
using System;
using System.Collections;
